...
describe('broccoli-pug2', () => {
  ...
  describe('JS output', () => {
    ...
    it('CommonJS', () => {
      return expect(compileFooJs('cjs')).to.eventually.match(/module\.exports =/)
    })
  ...
  describe('caching', () => {
    ...
    it('rebuilds only files that have changed dependencies', () => {
      ...
      return expect(builder.build()).to.eventually.deep.equal({
        ...
        expect(pugNode._stats.cacheHits).to.deep.equal(['bar.pug', 'nodeps.pug'])
        ...
        expect(pugNode._stats.cacheHits).to.deep.equal(['foo.pug', 'nodeps.pug'])
        ...
        expect(pugNode._stats.cacheHits).to.deep.equal(['bar.pug', 'foo.pug'])
